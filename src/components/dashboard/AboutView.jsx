      ...
      <div className="bg-white rounded-2xl shadow-xl p-8">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <a
              href="components/images/qrAuroraReleases.png" // En un caso real, este sería el enlace de descarga directo
              download
          ...
          <div>
            ...
            <div className="space-y-3">
              <a href="#" className="flex items-center p-4 bg-gray-50 hover:bg-gray-100 rounded-xl transition group">
                <FileText className="w-5 h-5 mr-3 text-gray-500 group-hover:text-primary transition" />
                <span className="font-semibold text-gray-700">Términos y Condiciones</span>
              </a>
              <a href="#" className="flex items-center p-4 bg-gray-50 hover:bg-gray-100 rounded-xl transition group">
                <ShieldCheck className="w-5 h-5 mr-3 text-gray-500 group-hover:text-primary transition" />
                <span className="font-semibold text-gray-700">Política de Privacidad y Datos</span>
              </a>
            </div>
          </div>
        </div>
